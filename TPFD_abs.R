...
# NOTE: This script is for absence calls 
# USE: depth_TPFD_abs.R
...
summarydata <- read.table("summary_depth_TPFD_abs.txt",header=TRUE,row.names=NULL)
...
ggsave(a_all,filename="Combined_Abs_Cov.png",dpi=300, width=7.5,height=5,units="in")
...
ggsave(a_all,filename="Combined_Abs_R.png",dpi=300, width=7.5,height=5,units="in")
...
filename <- paste("depth_TPFD_abs_scatter",fileID, sep ="_")
filename <- paste(filename,"tiff", sep =".")
ggsave(filename,dpi=300, width=7.5,height=3.5,units="in")
ggsave(filename,dpi=300, width=7.5,height=3.5,units="in")
...
ggsave(a_all,filename="Combined_Abs_Scatter.png",dpi=300, width=7.5,height=5,units="in")
