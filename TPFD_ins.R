...
# INSERTIONS round20
setwd("/Users/kristen/Desktop/Fig_p/depth_TPFD_files/round20")
...
m1
ggsave(filename="depth_TPFD_ins_round20.tiff",dpi=300, width=7.5,height=3.5,units="in")

# INSERTIONS round21
setwd("/Users/kristen/Desktop/Fig_p/depth_TPFD_files/round21")
summarydata <- read.table("summary_depth_TPFD_ins.txt",header=TRUE,row.names=NULL)
coverage<- read.table("mean_coverage_and_sd.txt",header=TRUE,row.names=NULL)
...
m2 <- m2 + geom_bar(binwidth=5)+ 
  ...
  scale_fill_manual(values = c("darkorange", "turquoise3", "slateblue1"))
m2
ggsave(filename="depth_TPFD_ins_round21.tiff",dpi=300, width=7.5,height=3.5,units="in")

# INSERTIONS round22
setwd("/Users/kristen/Desktop/Fig_p/depth_TPFD_files/round22")
summarydata <- read.table("summary_depth_TPFD_ins.txt",header=TRUE,row.names=NULL)
coverage<- read.table("mean_coverage_and_sd.txt",header=TRUE,row.names=NULL)
...
m3 <- m3 + geom_bar(binwidth=5)+ 
  ...
  scale_fill_manual(values = c("darkorange", "turquoise3", "slateblue1"))
m3
ggsave(filename="depth_TPFD_ins_round22.tiff",dpi=300, width=7.5,height=3.5,units="in")

# INSERTIONS round23
setwd("/Users/kristen/Desktop/Fig_p/depth_TPFD_files/round23")
summarydata <- read.table("summary_depth_TPFD_ins.txt",header=TRUE,row.names=NULL)
coverage<- read.table("mean_coverage_and_sd.txt",header=TRUE,row.names=NULL)
...
m4
ggsave(filename="depth_TPFD_ins_round23.tiff",dpi=300, width=7.5,height=3.5,units="in")

m_all<-plot_grid(m1,m4,m3,m2)
setwd("/Users/kristen/Desktop/Fig_p")
ggsave(filename="combined_ins_F.tiff",dpi=300, width=7.5,height=5,units="in")

########################################################################################################################
########################################################################################################################
########################################################################################################################

# INSERTIONS READ SUPPORT 20
setwd("/Users/kristen/Desktop/Fig_p/depth_TPFD_files/round20")
summarydata <- read.table("summary_depth_TPFD_ins.txt",header=TRUE,row.names=NULL)
...
m1
ggsave(filename="depth_TPFD_ins_RS_round20.tiff",dpi=300, width=7.5,height=3.5,units="in")



# INSERTIONS READ SUPPORT 20 Diff Bin
setwd("/Users/kristen/Desktop/Fig_p/depth_TPFD_files/round20")
summarydata <- read.table("summary_depth_TPFD_ins.txt",header=TRUE,row.names=NULL)
new_df<- summarydata[summarydata$call != "FN",]
summarydata <- new_df
...
m
ggsave(filename="depth_TPFD_ins_RS_round20_BIN.tiff",dpi=300, width=7.5,height=3.5,units="in")

# INSERTIONS READ SUPPORT 21
setwd("/Users/kristen/Desktop/Fig_p/depth_TPFD_files/round21")
summarydata <- read.table("summary_depth_TPFD_ins.txt",header=TRUE,row.names=NULL)
new_df<- summarydata[summarydata$call != "FN",]
summarydata <- new_df
...
m2 <- m2 + geom_bar(binwidth=5)+
  ...
  scale_fill_manual(values = c("darkorange", "slateblue1"))
m2
ggsave(filename="depth_TPFD_ins_RS_round21.tiff",dpi=300, width=7.5,height=3.5,units="in")

# INSERTIONS READ SUPPORT 22
setwd("/Users/kristen/Desktop/Fig_p/depth_TPFD_files/round22")
summarydata <- read.table("summary_depth_TPFD_ins.txt",header=TRUE,row.names=NULL)
new_df<- summarydata[summarydata$call != "FN",]
summarydata <- new_df
...
m3 <- m3 + geom_bar(binwidth=5)+
  ...
  scale_fill_manual(values = c("darkorange", "slateblue1"))
m3
ggsave(filename="depth_TPFD_ins_RS_round22.tiff",dpi=300, width=7.5,height=3.5,units="in")

# INSERTIONS READ SUPPORT 23
setwd("/Users/kristen/Desktop/Fig_p/depth_TPFD_files/round23")
summarydata <- read.table("summary_depth_TPFD_ins.txt",header=TRUE,row.names=NULL)
new_df<- summarydata[summarydata$call != "FN",]
summarydata <- new_df
...
m4
ggsave(filename="depth_TPFD_ins_RS_round23.tiff",dpi=300, width=7.5,height=3.5,units="in")
m_all<-plot_grid(m1,m4,m3,m2)
setwd("/Users/kristen/Desktop/Fig_p")
ggsave(filename="combined_ins_RS_F.tiff",dpi=300, width=7.5,height=5,units="in")
...
a1
ggsave(filename="depth_TPFD_ins_scatter_round20.tiff",dpi=300, width=7.5,height=3.5,units="in")
...
a2 <- a2 + geom_point(size=.75)+
  ...
  scale_colour_manual(values = c("darkorange", "slateblue1"))
a2
ggsave(filename="depth_TPFD_ins_scatter_round21.tiff",dpi=300, width=7.5,height=3.5,units="in")
...
print(coverage)
mean<-coverage$Mean
oneSD<-coverage$OneSD
twoSD<-coverage$TwoSD
threeSD<-coverage$ThreeSD
fourSD<-coverage$FourSD
new_df<- summarydata[summarydata$call != "FN",]
summarydata <- new_df
...
a3 <- a3 + geom_point(size=.75)+
  ...
  scale_colour_manual(values = c("darkorange", "slateblue1"))
a3
ggsave(filename="depth_TPFD_ins_scatter_round22.tiff",dpi=300, width=7.5,height=3.5,units="in")
...
a4 <- a4 + geom_point(size=.75)+
  ...
  scale_colour_manual(values = c("darkorange", "slateblue1"))
a4
ggsave(filename="depth_TPFD_ins_scatter_round23.tiff",dpi=300, width=7.5,height=3.5,units="in")

m_all<-plot_grid(a1,a4,a3,a2)
setwd("/Users/kristen/Desktop/Fig_p")
ggsave(filename="combined_ins_scatter_F.tiff",dpi=300, width=7.5,height=5,units="in")